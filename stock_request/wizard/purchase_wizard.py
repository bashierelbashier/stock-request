...
class PurchaseOrderLine(models.Model):
    ...
    request_line_id = fields.Many2one(comodel_name="stock.request.line", string="")
...
class PurchaseWizard(models.TransientModel):
    ...
    partner_id = fields.Many2one(
        comodel_name="res.partner", domain=[("supplier_rank", ">", 0)], string="Vendor"
    )
    qty = fields.Float(string="Quantity")
    date = fields.Datetime(string="Deadline Time", default=fields.Datetime.now())
